...
import FotoProfil from "../assets/image/fotome.png"
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p
              ...
              data-aos-duration="1500"
            >
              An adaptive and highly motivated Software Engineering graduate from SMKS Wikrama Bogor with hands
              on professional experience in full-stack web and mobile development. Proven track record in building
              enterprise-grade applications, utilizing modern frameworks like Laravel, React, and ASP.NET, alongside
              robust database management. Experienced in agile industrial environments, capable of delivering high
              quality code both independently and collaboratively within cross-functional teams.        </p>
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="/sirojul_kamal_cv.pdf" download="sirojul_kamal_cv.pdf" className="w-full lg:w-auto">
                <button
                  data-aos="fade-up"
                  data-aos-duration="800"
